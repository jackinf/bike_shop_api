...
def register_routes(app):
    ...
    # bike_app.add_routes([web.get('', handler.get_cart_for_user)])  # TODO: Remove?
    # bike_app.add_routes([web.post('', handler.add_to_cart)])  # TODO: Remove?
    # bike_app.add_routes([web.delete('', handler.remove_from_cart)])  # TODO: Remove?
